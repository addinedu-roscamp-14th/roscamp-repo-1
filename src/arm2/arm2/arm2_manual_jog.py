...
from .arm2_config import BAUD, PORT, SPEED
from .arm2_joint_limits import JOINT_LIMITS_DEG as JETCOBOT_JOINT_LIMITS_DEG
from .arm2_robot_utils import connect_robot
...
class ManualJogNode(Node):
    ...
    def __init__(self):
        ...
        super().__init__('arm2_manual_jog')
