...
```bash
ros2 service call /arm/homography_pick_place/start \
...
```bash
ros2 service call /arm/homography_pick_place/stop \
  std_srvs/srv/Trigger "{}"
```
...
[homography_pick_place.yaml](config/homography_pick_place.yaml)의
