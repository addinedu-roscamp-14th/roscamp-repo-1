...
class HomographyPickPlace(Node):
    ...
    def __init__(self):
        ...
        super().__init__('homography_pick_place')
        ...
        self.detection_control = self.create_publisher(
            Bool,
            '/arm/homography_pick_place/detection_enabled',
            control_qos,
        )
        self.status = self.create_publisher(
            String, '/arm/homography_pick_place/status', 10
        )
        self.work_state = self.create_publisher(
            String,
            '/arm/homography_pick_place/work_state',
            control_qos,
        )
        self.current_work_state = ''
        self.create_service(
            Trigger,
            '/arm/homography_pick_place/start',
            self.start,
            callback_group=self.callback_group,
        )
        self.create_service(
            Trigger,
            '/arm/homography_pick_place/stop',
            self.stop,
            callback_group=self.callback_group,
        )
        self.create_timer(
    ...
    def _declare_parameters(self):
        ...
        self.declare_parameter(
            'calibration_file',
            'calibration_results/floor_calibration.yaml',
        )
        self.declare_parameter(
            'stations_json',
    ...
    def start(self, _request, response):
        ...
        response.message = 'homography Pick/Place accepted'
        return response
