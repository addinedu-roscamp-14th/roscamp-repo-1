...
class ContainerPickCoordinator(Node):
    ...
    def __init__(self):
        ...
        self.stack_target_pose_publisher = self.create_publisher(
            PoseStamped, '/arm/container_pick/stack_target_pose', 10
        )
        ...
        self.stack_release_pose_publisher = self.create_publisher(
            PoseStamped, '/arm/container_pick/stack_release_pose', target_qos
        )
        self.stack_approach_pose_publisher = self.create_publisher(
            PoseStamped, '/arm/container_pick/stack_approach_pose', target_qos
        )
        self.create_service(Trigger, '/arm/pick_container', self.start_pick)
        self.create_service(Trigger, '/arm/preview_stack', self.preview_stack)
        self.create_service(Trigger, '/arm/stack_container', self.start_stack)
        self.create_service(
    ...
    def _declare_parameters(self):
        ...
        self.declare_parameter(
            'stack_target_frame', 'arm/stack_target_marker'
        )
