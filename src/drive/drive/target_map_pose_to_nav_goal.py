...
class TargetMapPoseToNavGoal(Node):
    ...
    def log_waiting_status(self):
        ...
        publisher_count = self.count_publishers(self.target_topic)
        self.get_logger().info(
